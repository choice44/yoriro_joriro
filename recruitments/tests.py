...
class RecruitmentCreateTest(APITestCase):
    ...
    def setUpTestData(cls):
        cls.user_data = {"email": "aaa@aaa.com", "nickname":"aaa", "password": "password"}
...
class RecruitmentEditTest(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        # 유저 2 생성
        cls.user_data2 = {"email": "bbb@bbb.com", "nickname":"bbb", "password": "password"}
...
class JoinApplicantTest(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        # 유저 3 생성
        cls.user_data3 = {"email": "ccc@ccc.com", "nickname":"ccc", "password": "password"}
